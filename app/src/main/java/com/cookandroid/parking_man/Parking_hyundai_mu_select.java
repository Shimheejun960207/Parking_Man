...
public class Parking_hyundai_mu_select extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 즐겨찾기 여부 검사
        if(starValidate.contains("hyundai_mu")) { // hyundai_mu 주차장의 키값 존재 여부
        ...
        btn_star.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(favAction.starClick(parking, validate)) {
                    ...
                    Toast.makeText(Parking_hyundai_mu_select.this, "즐겨찾기에 추가되었습니다.", Toast.LENGTH_SHORT).show();
                    btn_star.setBackgroundResource(R.drawable.star_full);
                    editor.putInt("hyundai_mu", 1);
                    editor.apply();

                    Log.d(TAG, "Put json");

                } else {
                    Toast.makeText(Parking_hyundai_mu_select.this, "즐겨찾기에 삭제되었습니다.", Toast.LENGTH_SHORT).show();
                    btn_star.setBackgroundResource(R.drawable.star_void);
                    editor.putInt("hyundai_mu", 0);
                    editor.apply();
    ...
    public int favValidate(SharedPreferences starValidate) {
        int validate;
        validate = starValidate.getInt("hyundai_mu", 0);
        return validate;
    }
}
